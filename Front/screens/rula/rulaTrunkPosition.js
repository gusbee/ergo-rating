...
class RulaTrunkPosition extends React.Component{
    ...
    goToNextStep = () => {
        ...
        this.props.navigation.navigate("RulaLegsPosition");
    }
            ...
            <View style={globalStyle.container}>
                ...
                <View style={globalStyle.wrapper}>
                    ...
                    <Text style={globalStyle.title}>
                        Position du tronc<Text style={{ color: "red"}}>*</Text>
                    </Text>
...
export default connect()(RulaTrunkPosition)
