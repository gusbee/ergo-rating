...
class RulaLegsPosition extends React.Component{
    ...
    goToNextStep = () => {
        ...
        this.props.navigation.navigate("RulaActivityPartTwo");
    }
                ...
                <View style={globalStyle.wrapper}>
                    ...
                    <View style={globalStyle.body}>
                        ...
                        <Text style={globalStyle.title}>
                            Position des jambes<Text style={{color: "red"}}>*</Text>
                        </Text>
...
export default connect()(RulaLegsPosition)
