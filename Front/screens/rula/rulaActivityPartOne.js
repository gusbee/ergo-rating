...
class RulaActivityPartOne extends React.Component{
    ...
    goToNextStep = () => {
        ...
        this.props.navigation.navigate("RulaNeckPosition");
    }
    ...
    handleObservation = () => {
        ...
        const action = {
            ...
            value: {
                activityScore1: activityScore + chargeScore,
            }
        }
...
export default connect()(RulaActivityPartOne)